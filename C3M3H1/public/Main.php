...
function generateMapObjects(int $controllable = 1, int $enemy = 2): array
{
    ...
    $monsterOption = generateMapOptions(false, true, true, $monsterOptionNumbers, 0.2);
    ...
    $treasureOptionNumbers = 0;
    $treasureOption = generateMapOptions(generable: true, number: $treasureOptionNumbers, rate: 0.5);
